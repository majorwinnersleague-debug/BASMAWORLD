  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center px-4 text-center">
      ...
      <p className="text-white/40 max-w-md mb-8 leading-relaxed">
        A Major Winners League community gaming initiative. More details coming soon!
      </p>
      <div className="flex flex-wrap gap-3 justify-center">
        ...
        <Link href="/mwl" className="border border-white/20 hover:border-white/40 text-white/60 hover:text-white px-6 py-3 rounded-xl font-semibold transition">
          ← Back to MWL
        </Link>
      </div>
    </div>
