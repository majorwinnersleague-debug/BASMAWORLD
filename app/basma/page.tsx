  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        sameAs: ['https://www.tiktok.com/@basma_singer', 'https://www.instagram.com/basma.tea'],
        ...
        <section className="max-w-4xl mx-auto px-4 pt-12 pb-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-8">
            ...
            <a href="https://www.tiktok.com/@basmateachme" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 bg-black border border-white/10 hover:border-white/30 text-white/60 hover:text-white px-5 py-2.5 rounded-xl font-medium transition text-sm">
              🪆 @basmateachme
            </a>
